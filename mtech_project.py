...
Original file is located at
    https://colab.research.google.com/drive/1E60KixdE5k0uinkKRfdn0CYOXZXiwQEQ
"""
...
#import matplotlib.pyplot as plt
#%matplotlib inline
#cluster_number=5#int(input("Enter number of clusters: "))
#kmeans_cluster=KMeans(n_clusters=cluster_number)
#kmeans_cluster.fit(vector_values1)
#centres=kmeans_cluster.labels_.tolist()
#print(np.shape(kmeans_cluster))
#cClusters=kmeans_cluster.cluster_centers_
#print(np.shape(vector_values1))
#print(centres)
#print(np.shape(centres))
#map_color={0:'blue', 1:'green', 2:'red', 3:'black', 4:'cyan',5:'yellow'}
#len=range(0,df.shape[0])
#for i in len:
#  df['Centre']=centres
#  df['Vector_Value']=np.array(vector_values1[1]).tolist()
